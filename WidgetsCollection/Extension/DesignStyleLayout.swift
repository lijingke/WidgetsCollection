...
class DesignStyleLayout : UICollectionViewFlowLayout {
    ...
    override var collectionViewContentSize: CGSize {
        ...
        //当前行的Y坐标
        let oneGroupHeight: CGFloat = CGFloat(line / 2) * (3.0 * unitWidth)
        ...
        let remainLineHeights: CGFloat = CGFloat(line % 2) * remainHeight
    ...
    -> UICollectionViewLayoutAttributes? {
        ...
        //当前行的Y坐标
        let oneGroupHeight: CGFloat = CGFloat(line / 2) * (3.0 * unitWidth)
        let remainHeight: CGFloat = CGFloat(line % 2) * (2 * unitWidth)
