//
//  VibrateListViewController.swift
//  WidgetsCollection
//
...
class VibrateListViewController: BaseViewController {
    ...
    func initHaptic() {
        ...
        do {
            ...
            Log.info("There was an error creating the engine: \(error.localizedDescription)")
        }
    }

    func destroyHaptics() {
        // The engine stopped; Log.info out why
        engine?.stoppedHandler = { reason in
            Log.info("The engine stopped: \(reason)")
        }
...
//            }
    ...
    func playHaptic(event: CHHapticEvent) {
        ...
        do {
            ...
            Log.info("Failed to play pattern: \(error.localizedDescription).")
        }
    }
}
