...
#Preview("Cell") {
    SymbolCell(symbol: Symbol(name: "shareplay", isMulticolor: true, isVariable: true), isFocused: false)
}

#Preview("Focused") {
    SymbolCell(symbol: Symbol(name: "shareplay", isMulticolor: true, isVariable: false), isFocused: true)
}
