...
class IconsViewController: UIViewController, UISearchBarDelegate, UISearchResultsUpdating {
    ...
    @objc private func willHideKeyboard(note _: Notification) {
        var insets = tableView.contentInset
        insets.bottom = .zero
...
private class IconDataSource: NSObject, UITableViewDataSource, UITableViewDelegate {
    ...
    init(cellIdentifier: String) {
        ...
        sections = [[String]](repeating: [], count: collation.sectionTitles.count)
...
private class IconSearchDataSource: NSObject, UITableViewDataSource, UITableViewDelegate {
    private let cellIdentifier: String
