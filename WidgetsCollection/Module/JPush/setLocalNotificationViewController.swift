...
class setLocalNotificationViewController: UIViewController, UITextFieldDelegate, UIGestureRecognizerDelegate {
    ...
    @IBOutlet var subtitleTF: UITextField!
    @IBOutlet var bodyTF: UITextField!
    @IBOutlet var badgeTF: UITextField!
    @IBOutlet var actionTF: UITextField!
    @IBOutlet var soundTF: UITextField!
    @IBOutlet var cateforyIdentifierTF: UITextField!
    @IBOutlet var threadIDTF: UITextField!
    @IBOutlet var summaryArgumentTF: UITextField!
    @IBOutlet var summaryArgCountTF: UITextField!
    @IBOutlet var requestIdentifierTF: UITextField!
    
    @IBOutlet var repeatSW: UISwitch!
    
    @IBOutlet var deliveredSW: UISwitch!
