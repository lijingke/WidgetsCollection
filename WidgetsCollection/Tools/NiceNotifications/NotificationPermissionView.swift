...
public class NotificationsPermissionView<Control: UIView>: UIView {
    ...
    public var onEnabled: (NotificationsPermissionView<Control>) -> () = { _ in }
    public var onDisabled: (NotificationsPermissionView<Control>) -> () = { _ in }
    public var onDeniedBySystem: (NotificationsPermissionView<Control>) -> () = { _ in }
...
public extension NotificationsPermissionView where Control == UISwitch {
    convenience init(group: LocalNotificationsGroup) {
