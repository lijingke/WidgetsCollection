...
extension PinpointKit: SenderDelegate {
    public func sender(_: Sender, didSend feedback: Feedback?, success _: SuccessType?) {
    ...
    public func sender(_: Sender, didFailToSend feedback: Feedback?, error: Error) {
...
public extension PinpointKitDelegate {
    func pinpointKit(_: PinpointKit, willSend _: Feedback) {}
    func pinpointKit(_: PinpointKit, didSend _: Feedback) {}

    func pinpointKit(_ pinpointKit: PinpointKit, didFailToSend _: Feedback, error: Error) {
