...
public extension EditorDelegate {
    func editor(_editor _: Editor, didSelect _: Tool) {
        // Do nothing
    }

    func editor(_: Editor, didMake _: AnnotationChange, to _: UIImage) {
        // Do nothing
    }

    func editorShouldDismiss(_: Editor, with _: UIImage) -> Bool {
        return true
    }

    internal func editorWillDismiss(_: Editor, with _: UIImage) {
        // Do nothing
    }

    func editorDidDismiss(_: Editor, with _: UIImage) {
        // Do nothing
    }
}
