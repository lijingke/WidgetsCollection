...
extension FeedbackViewController: EditorDelegate {
    public func editorWillDismiss(_: Editor, with screenshot: UIImage) {
...
extension FeedbackViewController: FeedbackTableViewDataSourceDelegate {
    func feedbackTableViewDataSource(feedbackTableViewDataSource _: FeedbackTableViewDataSource, didTapScreenshot _: UIImage) {
        guard let editor = editor else { return }
        guard let screenshotToEdit = screenshot else { return }
    ...
    @available(iOS 14, *)
    func feedbackTableViewDataSourceDidRequestScreenshot(feedbackTableViewDataSource _: FeedbackTableViewDataSource) {
