...
open class ScreenshotDetector: NSObject {
    ...
    @objc private func userTookScreenshot(_: Notification) {
    ...
    private func requestPhotosAuthorization() {
        func handleStatus(status: PHAuthorizationStatus) {
            ...
            case .denied, .notDetermined, .restricted:
                fail(with: .unauthorized(status: status))
            @unknown default:
                break
            }
        }
    ...
    fileprivate func findScreenshot() {
        ...
        imageManager.requestImage(for: screenshot,
                                  ...
                                  contentMode: .default,
                                  options: PHImageRequestOptions.highQualitySynchronousLocalOptions())
